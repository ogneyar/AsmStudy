...
;                 15-00 bits: dwCoord.x
    ...
    and dword ptr [r8+0],0;mov [r8+SMALL_RECT.Left],0
    ...
    invoke WriteConsole,hOut,&STR1,sizeof STR1,&BUFF,0 ;вывести строку
    ...
    ; lea r9d,LENS
    ; mov r8d,[r9]        ;длина вводимой строки
    ; invoke WriteConsole,hOut,&BUFF,,,0
