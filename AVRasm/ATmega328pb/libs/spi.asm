...
Speed_3: ; 4MHz при Fcpu=16MHz (2MHz при Fcpu=8MHz)
	; R16 = 3 -> fck/4   = 4MHz
	LDI		R17, 3
	CP		R16, R17 ; если 3
	BRNE	Speed_2
	ORI		R18, 0
	RJMP	EndSpeed
Speed_2: ; 1MHz при Fcpu=16MHz (500KHz при Fcpu=8MHz)
	; R16 = 2 -> fck/16  = 1MHz
	LDI		R17, 2
	CP		R16, R17 ; если 2
	BRNE	Speed_1
	ORI		R18, (1 << SPR0)
	RJMP	EndSpeed
Speed_1: ; 250KHz при Fcpu=16MHz (125KHz при Fcpu=8MHz)
	; R16 = 1 -> fck/64  = 250KHz
	LDI		R17, 1
	CP		R16, R17 ; если 1
	BRNE	Speed_0
	ORI		R18, (1 << SPR1)
	RJMP	EndSpeed
Speed_0: ; 125KHz при Fcpu=16MHz (60KHz при Fcpu=8MHz) - по умолчанию
...
EndSpeed:
	...
	LDI		R18, SPI2X ; умножение частоты на 2
	mOUT 	SPSR0, R18
