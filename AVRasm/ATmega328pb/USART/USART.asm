...
; Тестирование USART на микроконтроллере ATmega328pb
...
; Имена регистров, а также различные константы
	.equ 	F_CPU 					= 8000000		; Частота МК ATmega328pb
...
Program_name: .db "Test USART Transmit-Reseive on ATmega328pb",0
Hello_String: 
	.db '\n',"Hello Чел!",'\n','\n'
