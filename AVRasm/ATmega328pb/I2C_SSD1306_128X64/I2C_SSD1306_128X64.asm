...
; OLED SSD1306 I2C на микроконтроллере ATmega328pb
...
; Имена регистров, а также различные константы
	...
	.equ 	I2C_Frequency 			= 100000		; Частота шины I2C (работает даже на 1MHz)
	.equ 	I2C_UBRR 		= ((F_CPU/I2C_Frequency)-16)/2	; prescaler = 1
...
Program_name: .db "OLED SSD1306 I2C on ATmega328pb",0
