...
; I2C сканер на микроконтроллере ATtiny85
...
; Имена регистров, а также различные константы
	.equ 	F_CPU 					= 10000000		; Частота МК 16MHz

	.equ 	DIVIDER					= 1				; делитель
	.equ 	BAUD 					= 250000		; Скорость обмена по UART
...
; Program_name: .db "Search address I2C device on ATtiny85",0
