...
DIGITS8:
	...
	LDI		Temp2,100
DIG8_1:
	CP		Temp1,Temp2 ; Compare
	BRLO	DIG8_2 ; Branch if Lower (переход если был перенос, флаг "Carry") если Temp1 < Temp2
	SUB		Temp1,Temp2 ; Subtract without Carry (Temp1 = Temp1 - Temp2)
	; сотни
	INC		R26	
	RJMP	DIG8_1
DIG8_2:	
...
DIG8_3:
	CP		Temp1,Temp2 ; Compare
	BRLO	DIG8_4 ; Branch if Lower
	SUB		Temp1,Temp2 ; Subtract without Carry
	; десятки
	INC		R27		
	RJMP	DIG8_3
DIG8_4:
