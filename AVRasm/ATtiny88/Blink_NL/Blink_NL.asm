...
OUT 0x0a, R16 ; загрузим значение из регистра R16 в порт (DDRD = 0x0a)
; -- основной цикл программы -- 
Main: 	
	SBI 	0x0b, 0 ; подача на пин PD0 высокого уровня (PORTD = 0x0b)
	RCALL 	Wait ; вызываем функцию задержки по времени 
	CBI 	0x0b, 0 ; подача на пин PD0 низкого уровня  (PORTD = 0x0b)
	RCALL 	Wait ; вызываем функцию задержки по времени 	
