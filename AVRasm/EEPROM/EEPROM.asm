...
.equ Key = 128 ; устанавливаемое значение ячейки памяти в EEPROM
.SET Delay = 50 ; установка времени задержки 
...
Wait: 
	LDI R17, 25 ; загрузка константы для задержки в регистр R20 (Load Immediate)
WLoop0: 
	LDI R21, 0
	CPSE R21, R20 ; сравнение данных (Compare, Skip if Equal) пропустим следующую строку если значеия равны
	.SET Delay = 10
	LDI R18, Delay ; загружаем число в регистр R18 
WLoop1: 
